...
public class UsefulWebApplication {
	...
	private final static Logger logger = Logger
			.getLogger(UsefulWebApplication.class);
	 ...
	 *            : cuerpo del mensaje.
	 */
	public static void mostrarMensajeJSF(int severidad, String titulo,
			String descripcion) {
	...
	public static Date modificarFecha(Date fecha, int horas, int minutos,
			int segundos) {
	 ...
	 * @return
	 */
	public static BigDecimal convertirASolCantidadDol(BigDecimal tipoCambio,
			BigDecimal cantidadSol) {
		BigDecimal cantidadDol = BigDecimal.ZERO;
		if (tipoCambio == null) {
			tipoCambio = BigDecimal.ZERO;
		}
		cantidadDol = tipoCambio.multiply(cantidadSol).setScale(2,
	 ...
	 * @return
	 */
	public static BigDecimal convertirADolCantidadSol(BigDecimal tipoCambio,
			BigDecimal cantidadDol) {
