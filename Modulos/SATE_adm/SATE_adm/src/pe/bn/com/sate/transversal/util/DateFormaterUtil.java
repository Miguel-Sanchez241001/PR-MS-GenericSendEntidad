...
public class DateFormaterUtil {
	...
	private static final DateTimeFormatter formatterFechaCompleta = DateTimeFormat.forPattern("dd/MM/yyyy");
	private static final DateTimeFormatter formatterHora24Completa = DateTimeFormat.forPattern("HH:mm:ss");
	...
	private static final DateTimeFormatter formatterFechaHoraCompleta = DateTimeFormat
			.forPattern("dd/MM/yyyy hh:mm:ss");
	private static final DateTimeFormatter formatterTimestamp = DateTimeFormat.forPattern("yyyy-mm-dd hh:mm:ss");
	private static final DateTimeFormatter formatterHora = DateTimeFormat.forPattern("hh");
	private static final DateTimeFormatter formatterHora24 = DateTimeFormat.forPattern("HH");
	private static final DateTimeFormatter formatterMinutos = DateTimeFormat.forPattern("m");
	private static final DateTimeFormatter formatterFechaBD = DateTimeFormat.forPattern("dd/MM/yy");
	private static final DateTimeFormatter formatterFechaConstancia = DateTimeFormat.forPattern("dd/MM/yyyy HH:mm:ss");

	public static String fechaHoraCompleta(Date date){
		if(date==null) return null;
		return formatterFechaConstancia.print(DateTime.now().withMillis(date.getTime()));
	}
	...
	public static String fechaCompletaFormateada(Timestamp fecha) {
		...
		return formatterFechaCompleta.print(DateTime.now().withMillis(fecha.getTime()));
	}
	...
	public static String horaCompletaFormateada(Timestamp hora) {
		...
		return formatterHora24Completa.print(DateTime.now().withMillis(hora.getTime()));
	}
	...
	public static String horaFechaFormateada(Timestamp fecha, Timestamp hora) {
		...
		return fechaCompletaFormateada(fecha) + " " + horaCompletaFormateada(hora);
	}
	...
	public static Timestamp horaFechaTimestamp(Timestamp fecha, Timestamp hora) {
		...
		DateTime dateTime = formatterFechaHora24Completa.parseDateTime(horaFechaFormateada(fecha, hora));
	...
	public static Date dateDespues(Date date, int dias){
		Calendar cal = Calendar.getInstance();
		cal.setTime(date);
		cal.add(Calendar.DATE, +dias);
		return cal.getTime();
