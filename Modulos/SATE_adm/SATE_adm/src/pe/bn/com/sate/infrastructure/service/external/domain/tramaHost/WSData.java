package pe.bn.com.sate.infrastructure.service.external.domain.tramaHost;
...
public class WSData{
	...
	public String toShowData(){
		...
		if(campos!=null){ 
				for(int c=0; c<campos.length; c++){
				String temp = (campos[c].Descripcion.length()<20)? campos[c].Descripcion+ StringUtil.repeat(" ", 20-campos[c].Descripcion.length()):campos[c].Descripcion.substring(0,20);
