...
readonly LOGDIR=$2
readonly CTLDIR=$3
readonly DATAFILEPATTERN='^CHGACT[0-9]{6}\.(txt|TXT)$'
declare DATAFILE=''
readonly CTLFILE='CTL_CARGO.CTL'
readonly CTLLOGFILE='CTL_CARGO.LOG'
readonly LOGFILE='RECEPCION_CARGO.LOG'
readonly CONSFTP=$4
readonly CONSQL=$5
...
escribirLineaLog "*****************INICIO DEL SCRIPT - RECIBIR CARGOS******************"
...
escribirLineaLog "*******************FIN DEL SCRIPT - RECIBIR CARGOS*******************"
