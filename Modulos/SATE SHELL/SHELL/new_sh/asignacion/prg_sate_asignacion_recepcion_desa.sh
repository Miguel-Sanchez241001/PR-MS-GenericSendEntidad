...
readonly LOGDIR=$2
readonly CTLDIR=$3
readonly DATAFILEPATTERN='^FIASI[0-9]{6}\.(txt|TXT)$'
declare DATAFILE=''
readonly CTLFILE='CTL_ASIGNACION.CTL'
readonly CTLLOGFILE='CTL_ASIGNACION.LOG'
readonly LOGFILE='RECEPCION_ASIGNACION.LOG'
readonly CONSFTP=$4
readonly CONSQL=$5
...
escribirLineaLog "*****************INICIO DEL SCRIPT - RECIBIR CODIGO ASIGNACION******************"
...
execute BN_SATE.BNPD_12_ASIGNACION_ACT();
exit;
CONEXIONSQL
			codigoError=$?
			##
...
escribirLineaLog "*******************FIN DEL SCRIPT - RECIBIR CODIGO ASIGNACION*******************"
