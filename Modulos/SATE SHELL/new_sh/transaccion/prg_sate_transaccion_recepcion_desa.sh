...
readonly LOGDIR=$2
readonly CTLDIR=$3
readonly DATAFILEPATTERN='^FILOG[0-9]{6}\.(txt|TXT)$'
declare DATAFILE=''
readonly CTLFILE='CTL_TRANSACCION.CTL'
readonly CTLLOGFILE='CTL_TRANSACCION.LOG'
readonly LOGFILE='RECEPCION_TRANSACCION.LOG'
readonly CONSFTP=$4
readonly CONSQL=$5
...
escribirLineaLog "*****************INICIO DEL SCRIPT - RECIBIR TRANSACCIONES******************"
...
escribirLineaLog "*******************FIN DEL SCRIPT - RECIBIR TRANSACCIONES*******************"
