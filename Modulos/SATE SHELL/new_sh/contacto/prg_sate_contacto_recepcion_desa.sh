...
declare DATAFILE=''
readonly CTLFILE='CTL_CONTACTO.CTL'
readonly CTLLOGFILE='CTL_CONTACTO.LOG'
readonly LOGFILE='RECEPCION_CONTACTO.LOG'
readonly CONSFTP=$4
readonly CONSQL=$5
...
escribirLineaLog "*****************INICIO DEL SCRIPT - RECIBIR CONTACTOS******************"
...
execute BN_SATE.BNPD_08_CONTACTO_ACT();
exit;
CONEXIONSQL
			codigoError=$?
			##
...
escribirLineaLog "*******************FIN DEL SCRIPT - RECIBIR CONTACTOS*******************"
