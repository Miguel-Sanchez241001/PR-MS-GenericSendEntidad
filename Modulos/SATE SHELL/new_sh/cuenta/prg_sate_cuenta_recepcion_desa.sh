...
readonly LOGDIR=$2
readonly CTLDIR=$3
readonly DATAFILEPATTERN='^TRJAUT_[0-9]{10}\.(txt|TXT)$'
declare DATAFILE=''
readonly CTLFILE='CTL_CUENTA.CTL'
readonly CTLLOGFILE='CTL_CUENTA.LOG'
readonly LOGFILE='RECEPCION_CUENTA.LOG'
readonly CONSFTP=$4
readonly CONSQL=$5
...
escribirLineaLog "*****************INICIO DEL SCRIPT - RECIBIR CUENTAS_CARGO******************"
...
execute BN_SATE.BNPD_09_CUENTA_ACT();
exit;
CONEXIONSQL
			codigoError=$?
			##
...
escribirLineaLog "*******************FIN DEL SCRIPT - RECIBIR CUENTAS_CARGO*******************"